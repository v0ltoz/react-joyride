  ...
  var Store = function () {
    function Store() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          _ref$resetOnClose = _ref.resetOnClose,
          resetOnClose = _ref$resetOnClose === undefined ? false : _ref$resetOnClose;
...
var Joyride = function (_React$Component) {
  ...
  createClass(Joyride, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var mustReset = prevState.action === "next" && prevState.index === prevState.size;
